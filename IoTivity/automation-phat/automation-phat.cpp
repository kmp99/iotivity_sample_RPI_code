...
*/
int AutomationHat::CallPythonFunction(char moduleName[], char functionName[], int numArgs, int args[])
{
    int i;
...
AutomationHat *testAutomationHat;
...
class Adc1Resource : public Resource
{
    public:
         ...
         */
        Adc1Resource(std::string resourceUri = "/Temperature");
    ...
    private:
        ...
        std::string m_var_name_current = ""; // the name for the attribute "current"
        double m_var_value_desiredcurrent; // the value for the attribute "desiredcurrent": The desired electric current in Amps (A).
        std::string m_var_name_desiredcurrent = ""; // the name for the attribute "desiredcurrent"
...
OCRepresentation Adc1Resource::get(QueryParamsMap queries)
{
    ...
    testAutomationHat->CallPythonFunction((char *)"automation-hat", (char *)"readADC", 1, testAutomationHat->myParamArgs);
    ...
    std::cout << "\t\t" << "property 'temperature' : "<< m_var_value_voltage << std::endl;
...
class Adc2Resource : public Resource
{
    public:
         ...
         * @param resourceUri the uri for this resource
         */
        Adc2Resource(std::string resourceUri = "/Humidity");
    ...
    private:
        ...
        std::string m_var_name_rt = ""; // the name for the attribute "rt"
        double m_var_value_voltage; // the value for the attribute "voltage": The electric voltage in Volts (V).
        std::string m_var_name_voltage = "Humidity"; // the name for the attribute "voltage"
...
OCRepresentation Adc2Resource::get(QueryParamsMap queries)
{
    ...
    //std::cout << "\t\t" << "property 'frequency' : "<< m_var_value_frequency << std::endl;
    //std::cout << "\t\t" << "property 'n' : "<< m_var_value_n << std::endl;
    std::cout << "\t\t" << "property 'humidity' : "<< m_var_value_voltage << std::endl;
...
class Adc3Resource : public Resource
{
    public:
         ...
         * @param resourceUri the uri for this resource
         */
        Adc3Resource(std::string resourceUri = "/Moisture_Value");
    ...
    private:
        ...
        std::string m_var_name_rt = ""; // the name for the attribute "rt"
        double m_var_value_voltage; // the value for the attribute "voltage": The electric voltage in Volts (V).
        std::string m_var_name_voltage = ""; // the name for the attribute "voltage"
...
OCRepresentation Adc3Resource::get(QueryParamsMap queries)
{
    ...
    //std::cout << "\t\t" << "property '' : "<< m_var_value_current << std::endl;
    //std::cout << "\t\t" << "property '' : "<< m_var_value_desiredcurrent << std::endl;
    //std::cout << "\t\t" << "property '' : "<< m_var_value_desiredfrequency << std::endl;
    //std::cout << "\t\t" << "property '' : "<< m_var_value_desiredvoltage << std::endl;
    //std::cout << "\t\t" << "property '' : "<< m_var_value_frequency << std::endl;
    //std::cout << "\t\t" << "property '' : "<< m_var_value_n << std::endl;
    std::cout << "\t\t" << "property 'Moisture_Value' : "<< m_var_value_voltage << std::endl;
...
class Adc4Resource : public Resource
{
    public:
         ...
         * @param resourceUri the uri for this resource
         */
        Adc4Resource(std::string resourceUri = "/Distance");
    ...
    private:
        ...
        std::string m_var_name_rt = ""; // the name for the attribute "rt"
        double m_var_value_voltage; // the value for the attribute "voltage": The electric voltage in Volts (V).
        std::string m_var_name_voltage = "Distance"; // the name for the attribute "voltage"
...
OCRepresentation Adc4Resource::get(QueryParamsMap queries)
{
    ...
    //std::cout << "\t\t" << "property 'frequency' : "<< m_var_value_frequency << std::endl;
    //std::cout << "\t\t" << "property 'n' : "<< m_var_value_n << std::endl;
    std::cout << "\t\t" << "property 'Distance' : "<< m_var_value_voltage << std::endl;
...
class Input1Resource : public Resource
{
    public:
         ...
         * @param resourceUri the uri for this resource
         */
        Input1Resource(std::string resourceUri = "/Moisture_Status");
    ...
    private:
        ...
        std::string m_var_name_value = "Moisture_Status"; // the name for the attribute "value"
...
OCRepresentation Input1Resource::get(QueryParamsMap queries)
{
    OC_UNUSED(queries);
  	...
  	// alternative is to have a callback from the hardware that sets the member variables
    testAutomationHat->myParamArgs[0] = 1;
    testAutomationHat->CallPythonFunction((char *)"automation-hat", (char *)"readInput", 1, testAutomationHat->myParamArgs);
    m_var_value_value = (bool)testAutomationHat->returnLong;

    //std::cout << "\t\t" << "property 'n' : "<< m_var_value_n << std::endl;
    std::cout << "\t\t" << "property 'Moisture_Status' : "<< ((m_var_value_value) ? "true" : "false") << std::endl;
...
class Input2Resource : public Resource
{
    ...
    private:
        ...
        std::string m_var_name_rt = ""; // the name for the attribute "rt"
        bool m_var_value_value; // the value for the attribute "value": Status of the switch
        std::string m_var_name_value = ""; // the name for the attribute "value"
...
class Output1Resource : public Resource
{
    public:
         ...
         * @param resourceUri the uri for this resource
         */
        Output1Resource(std::string resourceUri = "/Shutter_Up_Down");
    ...
    private:
        ...
        std::string m_var_name_rt = ""; // the name for the attribute "rt"
        bool m_var_value_value; // the value for the attribute "value": Status of the switch
        std::string m_var_name_value = "Up_Down"; // the name for the attribute "value"
...
OCEntityHandlerResult Output1Resource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
    ...
    if (ehResult == OC_EH_OK)
    {
      ...
      testAutomationHat->myParamArgs[0] = 1;
      testAutomationHat->myParamArgs[1] = m_var_value_value ? 1 : 0;
      testAutomationHat->CallPythonFunction((char *)"automation-hat", (char *)"writeOutput", 2, testAutomationHat->myParamArgs);
    }
    return ehResult;
}
/*
...
class Output2Resource : public Resource
{
    public:
         ...
         * @param resourceUri the uri for this resource
         */
        Output2Resource(std::string resourceUri = "/Buzzer");
    ...
    private:
        ...
        std::string m_var_name_rt = ""; // the name for the attribute "rt"
        bool m_var_value_value; // the value for the attribute "value": Status of the switch
        std::string m_var_name_value = "Buzzer"; // the name for the attribute "value"
...
OCRepresentation Output2Resource::get(QueryParamsMap queries)
{
    ...
    //std::cout << "\t\t" << "property 'n' : "<< m_var_value_n << std::endl;
    std::cout << "\t\t" << "property 'Buzzer' : "<< ((m_var_value_value) ? "true" : "false") << std::endl;
...
class Output3Resource : public Resource
{
    public:
         ...
         * @param resourceUri the uri for this resource
         */
        Output3Resource(std::string resourceUri = "/LED");
    ...
    private:
        ...
        std::string m_var_name_rt = ""; // the name for the attribute "rt"
        bool m_var_value_value; // the value for the attribute "value": Status of the switch
        std::string m_var_name_value = "LED_Status"; // the name for the attribute "value"
...
OCRepresentation Output3Resource::get(QueryParamsMap queries)
{
    ...
    //std::cout << "\t\t" << "property '' : "<< m_var_value_n << std::endl;
    std::cout << "\t\t" << "property 'LED_Status' : "<< ((m_var_value_value) ? "true" : "false") << std::endl;
...
class RelayResource : public Resource
{
    ...
    private:
        ...
        std::string m_var_name_rt = ""; // the name for the attribute "rt"
        bool m_var_value_value; // the value for the attribute "value": Status of the switch
        std::string m_var_name_value = "Relay_Status"; // the name for the attribute "value"
...
OCRepresentation RelayResource::get(QueryParamsMap queries)
{
    ...
    //std::cout << "\t\t" << "property 'n' : "<< m_var_value_n << std::endl;
    std::cout << "\t\t" << "property 'Relay_Status' : "<< ((m_var_value_value) ? "true" : "false") << std::endl;
...
OCEntityHandlerResult RelayResource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
    ...
    if (ehResult == OC_EH_OK)
    {
      ...
      testAutomationHat->myParamArgs[0] = 1;
      testAutomationHat->myParamArgs[1] = m_var_value_value ? 1 : 0;
      testAutomationHat->CallPythonFunction((char *)"automation-hat", (char *)"writeRelay", 2, testAutomationHat->myParamArgs);
    }
    return ehResult;
}
/*
...
public:
    ...
    std::string  deviceName = "Xtrans_Iotivity_DevKit";
